...
interface Props {
  ...
  onDeleteKeyframe: (id: string) => Promise<void>;
}
                        ...
                        <div className="flex gap-2">
                          ...
                          <button
                            ...
                            onClick={async () => {
                              ...
                              setError(null);
                              try {
                                await onDeleteKeyframe(kf.id);
                                if (localCanonicalId === kf.id) setLocalCanonicalId(null);
                              } catch (err) {
                                setError(String(err));
                              } finally {
                                setDeletingId(null);
                            ...
                            className="min-h-10 min-w-10 flex items-center justify-center rounded-lg bg-red-900/20 hover:bg-red-900/40 border border-red-700/30 text-red-400 hover:text-red-300 transition-colors disabled:opacity-50"
      ...
      {kfModalIdx !== null && (
        <div className="fixed inset-0 z-50">
          <ImageModal
            ...
            onRemix={() => {}}
            onDelete={async (id) => {
              await onDeleteKeyframe(id);
              if (localCanonicalId === id) setLocalCanonicalId(null);
              setKfModalIdx(null);
            }}
            storyboard={storyboard}
          />
